...
$usnm=$_POST['tx_usnm'];
$pass=md5($_POST['tx_pas']);

$sql="SELECT * FROM `data_admin` WHERE `username`='$usnm' AND `password`='$pass'";
...
$count=mysql_num_rows($query);
	...
	{					
			...
			echo '</script>';			
			echo "<script type='text/javascript'>window.location.href='superadmin/index.php';</script>"; 
	}
	else
	{
...
<br><br>
    ...
    <div class="panel panel-default">
        <center><p class="panel-heading no-collapse">Login</p></center>
