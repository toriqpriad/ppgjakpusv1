		...
		<div class="search-well">
                <form class="form-inline" id="myForm" method="post">
					...
					<select name="kategori_select" class="form-control"  placeholder="Kategori Pencarian"> 
						<option value="id_peng">ID Pengajar</option>
						<option value="nm_peng">Nama Pengajar</option>
						...
						<option value="status">Status (MT/Pribumi)</option>
						<option value="pdkn">Pendidikan</option>
						<option value="kelas_ajar">Kelas Ajar</option>
						<option value="kontak">Kontak</option>
					</select>
					<input type="submit" value="Cari Data"  name="btn_cari" title="Cari Data" class="btn btn-danger form-control"> 
                	<a title="Tambah Data" href="data-pengajar.php?tambah" class="btn btn-success form-control"><span class="fa fa-plus"></span> Tambah Data</a>
                </form>
		</div>
		<div class="alert alert-success"><h3><strong>Pengajar</strong> adalah staff guru yang mendidik para generasi penerus (generus) dalam berbagai tingakatan kelas ajaran.</h3></div>
	<small>
