    ...
    <div class="content">
        <div class="header">
			...
			<ul class="breadcrumb">
				...
				<li class="active">Data Remaja</li>
			</ul>
		...
		<div class="search-well">
                <form class="form-inline" id="myForm" method="post">
					...
					<select name="kategori_select" class="form-control"  placeholder="Kategori Pencarian"> 
						<option value="id_rmj">ID Remaja</option>
						<option value="nm_rmj">Nama Remaja</option>
						...
						<option value="pdkn">Pendidikan (SMA/SMK/STM/MTA/Mahasiswa)</option>
						<option value="kls">Kelas</option>
						<option value="nm_sklh">Nama Sekolah/Nama Universitas</option>
                	...
                	<a title="Tambah Data" href="data-remaja.php?tambah" class="btn btn-success form-control"><span class="fa fa-plus"></span> Tambah Data</a>
                </form>
		</div>
		<div class="alert alert-default"><h5><strong>Remaja</strong> adalah para generasi penerus (generus) berusia antara 16 sampai usia nikah (belum menikah) yang diperkirakan berada di bangku sekolah menengah atau sederajat (SMA/SMK/STM/MTA),mahasiswa dan juga yang sudah bekerja.</h5></div>
	<small>
