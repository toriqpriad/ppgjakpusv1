...
<body class=" theme-blue">
  ...
  <!--<![endif]-->
    ...
    <li><a href="data-tpq.php?detail" class="nav-header"><i class="fa fa-fw fa-home"></i> Data TPQ</a></li>
        ...
        <li><ul class="praremaja nav nav-list collapse in">
            <li class="active"><a href="data-praremaja.php"><span class="fa fa-external-link"></span> Data Praremaja</a></li>
            </ul>
		</li>
...
<?php 
	...
	$skripdetail="SELECT * FROM data_praremaja inner join data_tpq on data_praremaja.tpq_desa=data_tpq.id_tpq where id_prmj='".$_GET['detail']."' AND tpq_desa='".$tpq_user."'";
	...
	echo '
		...
		<div class="col-md-3">
				<br>
				<img src="../images/foto_prmj/'.$selectdetail2->foto_prmj.'" class="img-responsive img-thumbnail" style="width:450px; height:330px;">	
			</div>
		<div class="col-md-9">
 ...
 <div class="panel-footer">
	...
	<a href="data-praremaja.php?hapus=<?=$selectdetail2->id_prmj;?>" onclick="return confirm('Yakin menghapus data ini?')" class="btn btn-danger"><span class="glyphicon glyphicon-trash" aria-hidden="true" title="Hapus"></span> Hapus</a>
	<?php
	echo '
	</div>
	<div class="col-md-6">
	<p class="text-right">
	<a href="export_to_xls_tpq.php?peng&&detail='.$selectdetail2->id_prmj.'" class="btn btn-warning"><i class=""fa fa-file-excel-o"" aria-hidden="true" title="Download sebagai Excel"></i> Download sebagai Excel (.xls)</a>
	<a href="export_to_word_tpq.php?peng&&detail='.$selectdetail2->id_prmj.'" class="btn btn-info"><i class=""fa fa-file-word-o"" aria-hidden="true" title="Download sebagai Dokumen"></i> Download sebagai Dokumen (.docx)</a>
	</p>
	</div>
...
<script type="text/javascript">
   ...
   <ul id="tabs" class="nav nav-tabs" data-tabs="tabs">
    ...
    <div id="my-tab-content" class="tab-content">
		...
		<br>
			<img src="../images/foto_prmj/'.$selectedit2->foto_prmj.'" id="gambar_nodin" width="400" alt="Preview Gambar" class="img-thumbnail img-responsive"/>
	...
	';
		...
		if (empty($foto))
		{ 
		$isi="Update data_praremaja set nm_prmj='".$nm."' ,j_klmn='".$klmn."', tmp_lhr='".$tmp_lhr."', tgl_lhr='".$tgl_lhr."',pdkn='".$pdkn."', kls='".$kls."',nm_sklh='".$sklh."', hobi='".$hobi."',  bapak='".$bpk."',  ibu='".$ibu."', kontak_prmj='".$kontak."', alamat_prmj='".$almt."'  WHERE id_prmj = '".$id."'";
		}
		elseif (!empty($foto))
		{ 
		$isi="Update data_praremaja set nm_prmj='".$nm."' ,j_klmn='".$klmn."', tmp_lhr='".$tmp_lhr."', tgl_lhr='".$tgl_lhr."',pdkn='".$pdkn."', kls='".$kls."',nm_sklh='".$sklh."', hobi='".$hobi."',  bapak='".$bpk."',  ibu='".$ibu."', kontak_prmj='".$kontak."', alamat_prmj='".$almt."',foto_prmj='".$foto."'  WHERE id_prmj = '".$id."'";
		}
		echo $isi;
