  ...
  <!--<![endif]-->
    ...
    <div class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="navbar-header">
          ...
          <a class="" href="index.html"><span class="navbar-brand">   SIM PPG Jakarta Pusat </span></a></div>
		...
		<div class="search-well">
                <form class="form-inline" id="myForm" method="post">
					...
					<select name="kategori_select" class="form-control"  placeholder="Kategori Pencarian"> 
						<option value="id_prmj">ID Praremaja</option>
						<option value="nm_prmj">Nama Praremaja</option>
						...
						<option value="pdkn">Pendidikan (SMP/MTs)</option>
						<option value="kls">Kelas</option>
						<option value="nm_sklh">Nama Sekolah</option>
						<option value="hobi">Hobi</option>
						<option value="bapak">Bapak</option>
						<option value="ibu">Ibu</option>
						<option value="kontak_prmj">Kontak</option>
					</select>
					<input type="submit" value="Cari Data"  name="btn_cari" title="Cari Data" class="btn btn-danger form-control"> 
                	<a title="Tambah Data" href="data-praremaja.php?tambah" class="btn btn-success form-control"><span class="fa fa-plus"></span> Tambah Data</a>
                </form>
		</div>
<div class="alert alert-error"><h3><strong>Praremaja</strong> adalah paragenerasi penerus (generus) berusia antara 13-16 yang diperkirakan berada di bangku sekolah pertama atau sederajat (SMP/MTs).</h3></div>
	<small>
		
			<?php include 'script-data-praremaja.php'; ?>
	</small>		
		</div>
				<?php tambah(); ?>
		</div>
