...
<body class=" theme-blue">
  ...
  <!--<![endif]-->
	...
	<br>
	<center><img src="img/<?=$hsl->logo;?>" class="img-responsive img-thumbnail" width="150"></center>
	<br>
    <ul>
    ...
    <li><a href="data-tpq.php" class="nav-header"><i class="fa fa-fw fa-home"></i> Data TPQ</a></li>
        ...
        <li class="active"><a href="tentang_akun.php" class="nav-header"><i class="fa fa-fw fa-info"></i>Tentang Akun</a></li>
	...
	<small>
			...
			<?php include 'script-data-admin.php'; ?>
	</small>		
		</div>
