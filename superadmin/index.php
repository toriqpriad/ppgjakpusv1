...
<head>
    <meta charset="utf-8">
    <title>Sistem Informasi PPG Jakarta Pusat</title>
        ...
        <div id="page-stats" class="panel-collapse panel-body collapse in">
					...
					<div class="col-sm-2">
                            <div class="knob-container">
                                <input class="knob"  data-width="150" data-min="0" data-max="50" data-displayPrevious="true" value="<?php echo $countdatatpq; ?>" data-fgColor="#92A3C2" data-readOnly=true;>
								<h3 class="text-muted text-center ">TPQ</h3>
                            </div>
                        </div>
						<div class="col-md-2">
                            <div class="knob-container">
                                <input class="knob" data-width="150" data-min="0" data-max="50" data-displayPrevious="true" value="<?php echo $countdatatpq; ?>" data-fgColor="#92A3C2" data-readOnly=true;>
                                <h3 class="text-muted text-center">Desa</h3>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="knob-container">
                                <input class="knob"  data-width="150" data-min="0" data-max="50" data-displayPrevious="true" value="<?php echo $countdatapeng; ?>" data-fgColor="#92A3C2" data-readOnly=true;>
                                <h3 class="text-muted text-center">Pengajar</h3>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="knob-container">
                                <input class="knob" data-width="150" data-min="0" data-max="50" data-displayPrevious="true" value="<?php echo $countdatacbr; ?>" data-fgColor="#92A3C2" data-readOnly=true;>
                                <h3 class="text-muted text-center">Caberawit</h3>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="knob-container">
                                <input class="knob" data-width="150" data-min="0" data-max="50" data-displayPrevious="true" value="<?php echo $countdatapraremaja; ?>" data-fgColor="#92A3C2" data-readOnly=true;>
                                <h3 class="text-muted text-center">Praremaja</h3>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="knob-container">
                                <input class="knob" data-width="150" data-min="0" data-max="50" data-displayPrevious="true" value="<?php echo $countdataremaja; ?>" data-fgColor="#92A3C2" data-readOnly=true;>
